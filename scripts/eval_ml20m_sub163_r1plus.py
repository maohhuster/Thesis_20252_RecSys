#!/usr/bin/env python3
"""Evaluate R1-plus (RLMRec-plus) checkpoints on subsampled-ML-20M test set (same-domain density control).
...
Usage:
    python3 scripts/eval_ml20m_sub163_r1plus.py
    python3 scripts/eval_ml20m_sub163_r1plus.py --layer-num 3 --device cpu
"""
...
CK_DIR = BENCH / "checkpoints_ml20m_sub163" / "r1plus" / "bge-large-en-v1.5"
...
def main():
    ...
    ap.add_argument("--layer-num", type=int, default=3,
                    help="Matches the upstream `lightgcn_plus.yml > model.ml20m_sub163_ours > layer_num: 3` "
                         "(consistent with the same-domain density control derived from ML-20M). "
    ...
    marker_dir = REPO / "code" / "benchmark" / "results_ml20m_sub163" / "r1plus" / "ml20m_sub163_ours"
    ...
    out_path = RESULTS_DIR / "r1plus_ml20m_sub163_metrics.json"
